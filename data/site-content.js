...
(function () {
  ...
  const siteContent = {
    ...
    nav: [
      ...
      { id: "solutions", label: "好物方案", href: "#solutions", ...status.formalCopy },
    ...
    values: [
      {
        title: "认识柚喜",
        description:
          "柚喜饰界，是一个围绕柚木知识、柚木好物、柚木整装、柚木地板、推荐厂商和爱好者社群建立的柚木生活方式入口。我们不把网站做成普通家具商城，而是先帮助用户看懂柚木，再根据需求连接合适的产品、空间方案和厂商资源。",
        ...status.formalCopy,
      },
      {
        title: "懂柚木的人，在这里交流",
