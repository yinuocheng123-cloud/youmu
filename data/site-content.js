...
(function () {
  ...
  const demoVendorNote =
    "当前为好物分类会员站样板展示位，不代表真实厂商资料或合作关系，上线前需替换为真实会员站资料。";
  ...
  const siteContent = {
    ...
    hero: {
      ...
      hook: "买柚木前，先来这里看一看。",
      description:
        "这里不是普通家具展示页，而是围绕柚木知识、好物方案、柚木整装、柚木地板、按好物分类展示的品牌或企业会员站和爱好者社群建立的柚木生活方式入口。想买柚木，先看懂；想做柚木，先被信任。",
      image: {
    ...
    values: [
      {
        title: "认识柚喜",
        description:
          "柚喜饰界，是一个围绕柚木知识、柚木好物、柚木整装、柚木地板、按好物分类展示的品牌或企业会员站和爱好者社群建立的柚木生活方式入口。我们不把网站做成普通家具展示页，而是先帮助用户看懂柚木，再根据需求连接合适的产品、空间方案和会员站资料。",
        ...status.formalCopy,
      },
      {
        title: "懂柚木的人，在这里交流",
    ...
    goods: {
      title: "柚木好物资料线索",
      subtitle: "按整装、地板、户外、茶室会客和家具好物查看资料线索、样板案例结构和会员站入口。",
      items: [
        {
          id: "fitout",
          title: "柚木整装方向",
    ...
    vendors: {
      ...
      subtitle:
        "先按好物分类进入对应资料线索，再继续查看会员站样板。会员展示不等于平台担保，真实合作前仍需结合产品、合同、交付、售后和服务边界继续确认。",
      sharedLabel: "会员站样板入口",
      items: [
        {
          name: "柚木地板会员站样板",
