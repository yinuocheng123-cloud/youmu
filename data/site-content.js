...
(function () {
  ...
  const siteContent = {
    ...
    hero: {
      ...
      actions: [
        { label: "咨询柚木问题", target: "#wechat", ...status.formalCopy },
    ...
    wechat: {
      ...
      subtitle: "先了解，再选择。",
      description:
        "无论你是在看柚木地板、柚木整装、柚木家具，还是想了解推荐厂商和真实应用场景，都可以先扫码咨询。先把材料、用途、预算和空间问题问明白，再做选择。",
      benefits: ["我想了解柚木材料和真假差异", "我想看柚木地板、整装或家具怎么选", "我想知道不同空间适合什么柚木方案", "我想了解推荐厂商和企业资料", "我想先避坑，再决定是否深入沟通"],
      qr: {
        src: "./assets/wecom-qr.jpg",
        alt: "扫码咨询柚木问题二维码",
        title: "扫码咨询柚木问题",
        note: "适合咨询：柚木地板 / 柚木整装 / 柚木家具 / 推荐厂商 / 选购避坑",
        mobileTip: "长按识别二维码，添加柚喜顾问。",
        caption: "你可以先说明所在城市、想看的品类、预算范围和当前疑问，我们再按需求提供资料或交流建议。",
        status: "userProvided",
