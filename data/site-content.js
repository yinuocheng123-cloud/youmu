  ...
  const siteContent = {
    ...
    nav: [
      { id: "about", label: "认识柚喜", href: "#about", ...status.formalCopy },
      {
        ...
        href: "#knowledge",
        children: [
          { label: "柚木入门", href: "#knowledge-starter" },
      ...
      { id: "solutions", label: "好物方案", href: "#goods", ...status.formalCopy },
      { id: "merchants", label: "推荐厂商", href: "#merchants", ...status.formalCopy },
    ...
    hero: {
      ...
      hook: "买柚木前，先来这里看一看。",
      description:
        "从材质辨别、选购避坑、户外使用、日常养护，到好物挑选和推荐厂商观察点，我们把柚木相关问题整理成可读、可问、可继续交流的内容，帮助你更稳地判断，也让好柚木被更多人看见。",
      image: {
      ...
      actions: [
        { label: "加入爱好者社群", target: "#wechat", ...status.formalCopy },
        { label: "咨询柚木选购", target: "#wechat", ...status.formalCopy },
        { label: "申请厂商合作", target: "#wechat", ...status.formalCopy },
      ],
      ...status.formalCopy,
    },
    values: [
      ...
      items: [
        {
          ...
          title: "柚木整装方向",
          subtitle: "柚木空间整体方案",
          description: "从地面、墙面、家具、软装和整体气质上考虑柚木的使用方式，适合庭院、茶室、会客厅、阳台、民宿、会所和私宅等空间。",
          image: {
    ...
    standards: {
      title: "我们如何推荐柚木厂商？",
      items: [
        { title: "看真实产品", description: "优先看实物细节、结构照片和不同光线下的材质状态，减少只看效果图带来的误判。", icon: "01", ...status.formalCopy },
        { title: "看材料说明", description: "说明木材来源、等级、拼板方式和用料边界，把能确认和不能确认的内容分开写清。", icon: "02", ...status.formalCopy },
        { title: "看工艺细节", description: "关注连接结构、边角处理、打磨手感、表面处理和户外使用后的稳定性。", icon: "03", ...status.formalCopy },
        { title: "看交付案例", description: "用真实空间验证产品落地效果，但必须在授权和真实性确认后再公开展示。", icon: "04", ...status.formalCopy },
        { title: "看服务承诺", description: "把交期、运输、安装、售后、保养建议和问题处理方式提前讲清楚。", icon: "05", ...status.formalCopy },
        { title: "看用户反馈", description: "持续沉淀长期使用后的真实评价，避免只展示刚交付时的“漂亮瞬间”。", icon: "06", ...status.formalCopy },
      ],
      ...status.formalCopy,
    },
    ...
    wechat: {
      ...
      description:
        "这里不是广告群，而是一个交流柚木知识、选购经验、空间方案和厂商共创的企业微信入口。喜欢柚木、正在看柚木整装或柚木地板、正在做柚木的人，都可以先添加柚喜顾问，再按需求进入社群、咨询或合作沟通。",
