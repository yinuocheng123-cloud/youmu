      ...
      items: [
        {
          ...
          description: "从桌面比例、腿型结构到长期使用后的色泽变化，进入一页可阅读、可收藏的柚木家具档案。",
          image: {
            src: "./assets/images/product-teak-table.jpg",
            alt: "柚木茶桌与茶室家具参考",
            ...status.openStockImage,
        ...
        },
        {
          ...
          description: "从脚感、光泽变化到时间留下的使用痕迹，进入一页围绕长期状态展开的地板档案。",
          image: {
            src: "./assets/images/knowledge-teak-grain.jpg",
        ...
        },
        {
          ...
          description: "从拼缝节奏、墙角收口到整面上墙后的气质变化，进入一页围绕墙面木作展开的整装档案。",
          image: {
        ...
        },
        {
          ...
          description: "从排水缝隙、脚底触感到长期界面状态，进入一页围绕经典户外应用展开的档案。",
          image: {
        ...
        },
        {
          ...
          description: "从旧料痕迹、空间装饰到改造利用方式，进入一页围绕老门阅读展开的收藏档案。",
          image: {
        ...
        },
        {
          ...
          description: "从边缘手感、承托比例到日常使用顺手感，进入一页围绕桌面小木作展开的文创档案。",
          image: {
            src: "./assets/images/vendor-craft-sample.jpg",
            alt: "柚木托盘与小件木作参考",
            ...status.openStockImage,
