...
(function () {
  ...
  const siteContent = {
    ...
    wechat: {
      title: "有柚木问题，可以直接问我们。",
      subtitle: "材料、家具、空间和养护问题，都可以先聊清楚。",
      description:
        "说清使用场景和具体疑问，我们会尽量给出直接、易懂的参考。",
    ...
    footer: {
      contact: {
        phone: { label: "柚木咨询", value: "可咨询柚喜，沟通柚木问题", ...status.formalCopy },
        email: { label: "资料合作", value: "可通过生态合作页提交资料", ...status.formalCopy },
        address: {
          label: "联系方式",
