...
(function () {
  ...
  const siteContent = {
    ...
    goods: {
      title: "柚木好物",
      subtitle: "发现柚木家具、地板、茶室、户外、收藏和文创好物。",
      items: [
        {
          id: "furniture",
          title: "柚木家具",
          subtitle: "茶桌、餐桌、书桌、书柜、边几、躺椅",
          description: "看比例、结构、触感和长期使用后的状态。",
          image: {
          ...
          tags: ["茶桌", "书柜", "边几"],
          points: ["关注比例与结构", "关注触感与表面处理", "关注长期使用后的状态"],
          action: "发现柚木家具",
          ...status.demoProduct,
        },
        {
          id: "flooring",
          title: "柚木地板",
          subtitle: "住宅地板、茶室地面、露台平台",
          description: "看脚感、色泽、稳定性和岁月变化。",
          image: {
            src: "./assets/images/knowledge-teak-grain.jpg",
            alt: "柚木地板纹理与材料参考",
            ...status.openStockImage,
        ...
        },
        {
          id: "tea-room",
          title: "柚木茶室",
          subtitle: "茶桌、茶柜、地面、墙板、灯光、摆件",
          description: "看材质如何形成安静、温润的空间气质。",
          image: {
            src: "./assets/images/product-teak-table.jpg",
            alt: "柚木茶室与茶桌参考",
            ...status.openStockImage,
        ...
        },
        {
          id: "outdoor",
          title: "柚木户外",
          subtitle: "户外桌椅、庭院平台、露台地板、花园家具",
          description: "看结构、耐候、风化和维护后的状态。",
          image: {
        ...
        },
        {
          id: "collection",
          title: "柚木收藏",
          subtitle: "老门、老窗、老船木、老料、雕刻和器物",
          description: "看时间痕迹、纹理、尺寸和收藏故事。",
          image: {
        ...
        },
        {
          id: "creative",
          title: "柚木文创",
          subtitle: "托盘、笔、手机架、音箱、摆件和小器物",
          description: "看手感、尺度、工艺和日常使用趣味。",
          image: {
