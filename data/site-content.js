      ...
      items: [
        {
          ...
          description: "从桌面比例、腿型结构到长期使用后的色泽变化，感受柚木家具进入日常后的样子。",
          image: {
            src: "./assets/images/product-teak-table.jpg",
            alt: "柚木茶桌与茶室家具参考",
            ...status.openStockImage,
        ...
        },
        {
          ...
          description: "从脚感、拼接缝隙到光线变化下的色差，观察柚木地面如何陪伴长期生活。",
          image: {
            src: "./assets/images/knowledge-teak-grain.jpg",
            alt: "住宅柚木地板纹理与空间参考",
            ...status.openStockImage,
          ...
          tags: ["柚木地板", "住宅", "内容流"],
          points: ["关注拼接缝隙", "关注脚感反馈", "关注光线下的色差变化"],
          action: "发现住宅柚木地板",
          ...status.demoProduct,
        },
        {
        ...
        },
        {
          id: "outdoor",
          title: "柚木户外椅",
          subtitle: "适合阳台、露台和庭院停留场景",
          description: "从靠背角度、五金连接到雨后恢复状态，观察户外木作是否经得起长时间使用。",
          image: {
        ...
        },
        {
          ...
          description: "从虫眼修补、边角损耗到原始五金痕迹，观察旧柚木如何保留时间留下的层次。",
          image: {
        ...
        },
        {
          ...
          description: "从边缘手感、底部防滑到承托后的视觉比例，观察小件木作如何进入每天会碰到的动作里。",
          image: {
            src: "./assets/images/vendor-craft-sample.jpg",
            alt: "柚木托盘与小件木作参考",
            ...status.openStockImage,
          ...
          tags: ["柚木文创", "托盘", "内容流"],
          points: ["关注边缘手感", "关注底部防滑", "关注承托后的视觉比例"],
          action: "发现柚木托盘",
          ...status.demoProduct,
        },
      ],
